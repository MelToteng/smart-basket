...
@dso_cache = dso_local local_unnamed_addr global [52 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.2_name, ; name: libbarhopper_v3.so
		ptr null; void* handle (0x0)
	}, ; 2
	%struct.DSOCacheEntry {
...
@.env.7 = private unnamed_addr constant [37 x i8] c"cdaeeeda-8423-444f-a227-0d666afb0442\00", align 16
...
@.DSOCacheEntry.2_name = private unnamed_addr constant [19 x i8] c"libbarhopper_v3.so\00", align 16
@.DSOCacheEntry.3_name = private unnamed_addr constant [32 x i8] c"libmlkit_google_ocr_pipeline.so\00", align 16
